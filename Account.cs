...
namespace ClubManageApp
{
    ...
    {
        private string connectionString = @"Data Source=DESKTOP-HE7MI7F\SQLEXPRESS;Initial Catalog=QL_CLB_LSC;Integrated Security=True;TrustServerCertificate=True";

...
IF EXISTS (SELECT name FROM sys.databases WHERE name = N'QL_APP_LSC')
BEGIN
    ALTER DATABASE QL_APP_LSC SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE QL_APP_LSC;
END
GO

CREATE DATABASE QL_APP_LSC;
GO

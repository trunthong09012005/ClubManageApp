...
namespace ClubManageApp
{
    ...
    public static class ConnectionHelper
    {
        ...
        private static string _connectionString = @"Data Source=21AK22-COM;Initial Catalog=QL_CLB_LSC;User ID=sa;Password=912005;Encrypt=True;TrustServerCertificate=True";
